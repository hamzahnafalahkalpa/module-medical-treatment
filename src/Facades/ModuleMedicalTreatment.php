...
namespace Hanafalah\ModuleMedicalTreatment\Facades;
 ...
 */
class ModuleMedicalTreatment extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleMedicalTreatment\Contracts\ModuleMedicalTreatment::class;
  }
}
